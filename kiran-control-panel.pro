...
SOURCES += \
        main.cpp \
    kiran-mode-class-wgt.cpp \
    kiran-control-panel-window.cpp \
    kiran-control-panel.cpp \
    kiran-mode-class-item.cpp \
    kiran-mode-class-delegate.cpp \
    kiran-mode-class-item-wgt.cpp

HEADERS += \
    kiran-mode-class-wgt.h \
    kiran-control-panel-window.h \
    kiran-control-panel.h \
    kiran-mode-class-item.h \
    kiran-mode-class-delegate.h \
    kiran-mode-class-item-wgt.h

FORMS += \
    kiran-control-panel.ui \
    kiran-mode-class-item.ui

include(kiran-control-panel_global.pri)
include( kiran-model-item-wgt.pri)
