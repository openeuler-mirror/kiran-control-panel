 ...
 */
#ifndef __TOUCHPAD_SUBITEM_H__
#define __TOUCHPAD_SUBITEM_H__
...
class TouchPadSubItem : public QObject,
                        public KiranControlPanel::PluginSubitemInterface
{
    Q_OBJECT
public:
    TouchPadSubItem(QObject* parent = nullptr)
        : QObject(parent)
    {
    }
    ~TouchPadSubItem()
