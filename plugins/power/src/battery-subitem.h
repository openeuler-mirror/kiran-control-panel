 ...
 */
#ifndef __BATTERY_SUBITEM_H__
#define __BATTERY_SUBITEM_H__
...
class BatterySubItem : public QObject,
                       public KiranControlPanel::PluginSubitemInterface
{
    Q_OBJECT
public:
    BatterySubItem(QObject* parent = nullptr)
        : QObject(parent)
    {
    }
    ~BatterySubItem()
...
public:
    ...
    {
        return "kcp-power-battery-settings";
    }
