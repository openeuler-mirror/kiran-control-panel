 ...
 */
#ifndef __POWER_SUBITEM_H__
#define __POWER_SUBITEM_H__
...
class PowerSubItem : public QObject,
                     public KiranControlPanel::PluginSubitemInterface
{
    Q_OBJECT
public:
    PowerSubItem(QObject* parent = nullptr)
        : QObject(parent)
    {
    }
    ~PowerSubItem()
...
public:
    ...
    {
        return "kcp-power-power-settings";
    }
