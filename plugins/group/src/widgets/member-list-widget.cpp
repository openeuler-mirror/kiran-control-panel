...
MemberListWidget::MemberListWidget(QWidget *parent, QString userName) : QWidget(parent), userName(userName)
{
    initUI();
}
...
void MemberListWidget::initUI()
{
    ...
    deleteMemberButton->setIcon(QIcon::fromTheme("ksvg-trash"));
