...
#ifndef __LANGUAGE_SUBITEM_H__
#define __LANGUAGE_SUBITEM_H__
...
class LanguageSubItem : public QObject,
                        public KiranControlPanel::PluginSubitemInterface
{
    Q_OBJECT

public:
    LanguageSubItem(CreateWidgetFunc func, QObject* parent = nullptr);
    ~LanguageSubItem();
public:
