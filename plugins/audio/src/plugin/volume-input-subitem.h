 ...
 */
#ifndef __VOLUME_INPUT_SUBITEM_H__
#define __VOLUME_INPUT_SUBITEM_H__
...
class VolumeIntputSubItem : public QObject,
                            public KiranControlPanel::PluginSubitemInterface
{
    Q_OBJECT
public:
    VolumeIntputSubItem(QObject* parent = nullptr)
        : QObject(parent)
    {
    }
    ~VolumeIntputSubItem()
