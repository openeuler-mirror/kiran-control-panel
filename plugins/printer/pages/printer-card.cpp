      ...
      m_info(info)
{
    ...
    applyTheme();
    refreshUi();
    connect(DEFAULT_PALETTE(), &Palette::baseColorsChanged, this, &PrinterCard::applyTheme);
}
...
void PrinterCard::initUi()
{
    ...
    KiranPushButton::setButtonType(m_setDefaultButton, KiranPushButton::BUTTON_Normal);
    ...
    KiranPushButton::setButtonType(testButton, KiranPushButton::BUTTON_Normal);
    ...
    KiranPushButton::setButtonType(propsButton, KiranPushButton::BUTTON_Normal);
...
void PrinterCard::applyTheme()
{
    ...
    QPalette modelPal;
    modelPal.setColor(QPalette::WindowText, palette->getColor(Palette::DISABLED, Palette::TEXT));
    m_modelLabel->setPalette(modelPal);
