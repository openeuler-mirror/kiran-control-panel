 ...
 */
#ifndef __DISPLAYSUBITEM_H__
#define __DISPLAYSUBITEM_H__
...
class DisplaySubitem : public QObject,
                       public KiranControlPanel::PluginSubitemInterface
{
    Q_OBJECT
public:
    explicit DisplaySubitem(QObject* parent = nullptr) : QObject(parent)
    {
    }
    ~DisplaySubitem() {}
