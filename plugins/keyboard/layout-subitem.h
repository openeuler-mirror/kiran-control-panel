 ...
 */
#ifndef __LAYOUT_SUBITEM_H__
#define __LAYOUT_SUBITEM_H__
...
class LayoutSubItem : public QObject,
                      public KiranControlPanel::PluginSubitemInterface
{
    Q_OBJECT
public:
    LayoutSubItem(QObject* parent = nullptr)
        : QObject(parent)
    {
    }
    ~LayoutSubItem()
...
public:
    ...
    {
        return "ksvg-kcp-keyboard-layout";
    }
