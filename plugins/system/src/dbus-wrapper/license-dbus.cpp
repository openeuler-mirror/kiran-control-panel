...
bool InfoDbus::KylinLicense::getLicenseJson(QString &licenseInfo) {
  QDBusMessage msgMethodCall = QDBusMessage::createMethodCall(
      LICENSE_DBUS_NAME, LICENSE_DBUS_OBJECT_PATH, KIRAN_LICENSE_INTERFACE,
      METHOD_GET_LICENSE_JSON);
  QDBusMessage msgReply = QDBusConnection::systemBus().call(
      msgMethodCall, QDBus::Block, TIMEOUT_MS);
...
bool InfoDbus::KylinLicense::registerByLicenseCode(QString licenseCode,
                                                   QString &errorMsg) {
  QDBusMessage msgMethodCall = QDBusMessage::createMethodCall(
      LICENSE_DBUS_NAME, LICENSE_DBUS_OBJECT_PATH, KIRAN_LICENSE_INTERFACE,
...
bool InfoDbus::KylinLicense::registerByUsbKey(QString &points,
                                              QString &errorMsg) {
  QDBusMessage msgMethodCall = QDBusMessage::createMethodCall(
      LICENSE_DBUS_NAME, LICENSE_DBUS_OBJECT_PATH, KIRAN_LICENSE_INTERFACE,
...
bool InfoDbus::KylinLicense::registerOnline(QString ip, QString &errorMsg) {
  ...
  QDBusMessage msgReply = QDBusConnection::systemBus().call(
      msgMethodCall, QDBus::Block, TIMEOUT_MS_ONLINE);
