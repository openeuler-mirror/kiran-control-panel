...
class KiranControlPanelModelRunaloneWindow : public KiranTitlebarWindow
{
    Q_OBJECT

public:
    explicit KiranControlPanelModelRunaloneWindow();
    ~KiranControlPanelModelRunaloneWindow();
