...
< /message>
< message >
<location filename = "../src/widgets/account-itemwidget.cpp"
line = "112" / >
...
< message >
<location filename = "../src/pages/advance-settings-page/advance-settings.cpp"
line = "112" / >
    <source>Advance
Settings < /source>
...
< /message>
< message >
<location filename = "../src/pages/advance-settings-page/advance-settings.ui"
line = "14" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_advance-settings.h"
line = "203" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_advance-settings.h"
line = "203" / >
<source>Form < /source>
< translation > </translation>
< /message>
...
< message >
<location filename = "../src/pages/auth-manager-page/auth-manager-page.ui"
line = "14" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_auth-manager-page.h"
line = "179" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_auth-manager-page.h"
line = "179" / >
...
< /message>
< message >
<location filename = "../src/pages/auth-manager-page/auth-manager-page.cpp"
line = "162" / >
    <source>add
fingerprint < /source>
...
< message >
<location filename = "../src/widgets/biometric-item.ui"
line = "14" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_biometric-item.h"
line = "77" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_biometric-item.h"
line = "77" / >
...
type < /source>
< translation
type = "vanished" > 账户类型 < /translation>
< /message>
< message >
<location filename = "../src/pages/create-user-page/create-user-page.cpp"
line = "80" / >
...
< /message>
< message >
<location filename = "../src/pages/create-user-page/create-user-page.ui"
line = "14" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_create-user-page.h"
line = "286" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_create-user-page.h"
line = "286" / >
<source>Form < /source>
< translation > </translation>
< /message>
...
exists < /source>
< translation
type = "vanished" > 账户名已存在 < /translation>
    < /message>
    < message >
    <source>Please
enter
...
name < /source>
< translation
type = "vanished" > 请输入用户名 < /translation>
< /message>
< message >
<location filename = "../src/pages/create-user-page/create-user-page.cpp"
line = "99" / >
...
< message >
<location filename = "../src/pages/biometric-enroll-dialog/face-enroll-dialog/face-enroll-dialog.ui"
line = "14" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_face-enroll-dialog.h"
line = "122" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_face-enroll-dialog.h"
line = "122" / >
...
line = "124" / >
    <source>save < /source>
    < translation
type = "unfinished" > 保存 < /translation>
< /message>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/face-enroll-dialog/face-enroll-dialog.ui"
line = "159" / >
...
line = "125" / >
    <source>cancel < /source>
    < translation
type = "unfinished" > 取消 < /translation>
< /message>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/face-enroll-dialog/face-enroll-dialog.cpp"
line = "69" / >
    <source>initializing
face
collection
...
< translation
type = "unfinished" > 正在初始化人脸采集环境，请稍后 < /translation>
< /message>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/face-enroll-dialog/face-enroll-dialog.cpp"
line = "119" / >
...
environment! < /source>
< translation
type = "unfinished" > 初始化人脸采集环境失败! < /translation>
< /message>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/face-enroll-dialog/face-enroll-dialog.cpp"
line = "130" / >
...
collection < /source>
< translation
type = "unfinished" > 开始采集失败 < /translation>
    < /message>
    < /context>
    < context >
    ...
    <source>save < /source>
    < translation
type = "vanished" > 保存 < /translation>
    < /message>
    < message >
    <source>cancel < /source>
    < translation
type = "vanished" > 取消 < /translation>
    < /message>
    < message >
    <source>initializing
face
...
< translation
type = "vanished" > 正在初始化人脸采集环境，请稍后 < /translation>
< /message>
< message >
<source>failed
to
...
environment! < /source>
< translation
type = "vanished" > 初始化人脸采集环境失败! < /translation>
    < /message>
    < message >
    <source>Failed
to
...
collection < /source>
< translation
type = "vanished" > 开始采集失败 < /translation>
< /message>
< /context>
< context >
<name>FingerprintEnrollDialog < /name>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/fingerprint-enroll-dialog/fingerprint-enroll-dialog.ui"
line = "14" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_fingerprint-enroll-dialog.h"
line = "131" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_fingerprint-enroll-dialog.h"
line = "131" / >
...
< /message>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/fingerprint-enroll-dialog/fingerprint-enroll-dialog.cpp"
line = "49" / >
    <source>Finger
Enroll < /source>
< translation
type = "unfinished" > 指纹录入 < /translation>
< /message>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/fingerprint-enroll-dialog/fingerprint-enroll-dialog.cpp"
line = "127" / >
...
line = "154" / >
    <source>Error < /source>
    < translation
type = "unfinished" > 错误 < /translation>
    < /message>
    < /context>
    < context >
...
Enroll < /source>
< translation
type = "vanished" > 指纹录入 < /translation>
    < /message>
    < message >
    <source>Error < /source>
    < translation
type = "vanished" > 错误 < /translation>
< /message>
< /context>
< context >
<name>FingerprintInputWorker < /name>
< message >
<location filename = "../src/pages/biometric-enroll-dialog/fingerprint-enroll-dialog/fingerprint-enroll-worker.cpp"
line = "79" / >
    <source>initializing
fingerprint
collection
...
< message >
<location filename = "../src/hard-worker.cpp"
line = "46" / >
    <source>Create
User
failed < /source>
...
<source>password < /source>
< translation
type = "vanished" > 密码 < /translation>
    < /message>
    < message >
    <source>home
directory < /source>
< translation
type = "vanished" > 用户目录 < /translation>
    </message>
    <message>
        <source>shell</source>
...
delete user < /source>
< translation
type = "vanished" > 删除用户失败 < /translation>
< /message>
< /context>
< context >
<name>KiranAccountManager < /name>
< message >
<location filename = "../src/kiran-account-manager.cpp"
line = "94" / >
<location filename = "../src/kiran-account-manager.cpp"
line = "403" / >
<source>disable < /source>
...
new user < /source>
< translation
type = "unfinished" > 创建新用户 < /translation>
    < /message>
    < message >
    <source>User
Manager < /source>
< translation
type = "vanished" > 账户管理工具 < /translation>
    < /message>
    < message >
    <source>Create
new account < /source>
< translation
type = "vanished" > 创建新用户 < /translation>
< /message>
< /context>
< context >
<name>KiranAvatarEditor < /name>
< message >
<location filename = "../avatar-editor/src/kiran-avatar-editor.cpp"
line = "40" / >
    <source>Avatar
Editor < /source>
...
<name>KiranTips < /name>
< message >
<location filename = "../src/widgets/kiran-tips.ui"
line = "29" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_kiran-tips.h"
line = "71" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_kiran-tips.h"
line = "71" / >
        <source>Form</source>
        <translation></translation>
    </message>
...
< /message>
< message >
<location filename = "../src/pages/passwd-expiration-policy/password-expiration-policy-page.ui"
line = "318" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_password-expiration-policy-page.h"
line = "256" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_password-expiration-policy-page.h"
line = "256" / >
    <source>
return </source>
< translation > 返回 < /translation>
< /message>
< message >
<location filename = "../src/pages/passwd-expiration-policy/password-expiration-policy-page.cpp"
line = "66" / >
<location filename = "../src/pages/passwd-expiration-policy/password-expiration-policy-page.cpp"
line = "73" / >
<location filename = "../src/pages/passwd-expiration-policy/password-expiration-policy-page.cpp"
...
< message >
<location filename = "../src/pages/select-avatar-page/select-avatar-page.cpp"
line = "147" / >
<source>Confirm < /source>
< translation > 确认 < /translation>
< /message>
...
< message >
<location filename = "../src/pages/user-info-page/user-info-page.ui"
line = "14" / >
<location filename = "../build/kiran-cpanel-account_autogen/include/ui_user-info-page.h"
line = "520" / >
<location filename = "../cmake-build-debug/kiran-cpanel-account_autogen/include/ui_user-info-page.h"
line = "520" / >
        <source>Form</source>
        <translation></translation>
    </message>
...
< /message>
< message >
<location filename = "../src/pages/user-info-page/user-info-page.cpp"
line = "136" / >
<source>standard < /source>
< translation > 普通用户 < /translation>
< /message>
...
successfully < /source>
< translation
type = "vanished" > 账户信息更新成功 < /translation>
< /message>
< message >
<location filename = "../src/pages/user-info-page/user-info-page.cpp"
line = "314" / >
...
user( % 1
    ...
    ? </source>
    < translation > 用户目录下的目录和文件会随用户一起删除，确定要删除 % 1
用户吗？</translation>
< /message>
< message >
<location filename = "../src/pages/user-info-page/user-info-page.cpp"
