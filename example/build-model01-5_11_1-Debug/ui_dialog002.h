...
public:
    ...
    void setupUi(QDialog *Dialog002)
    {
        ...
        buttonBox = new QDialogButtonBox(Dialog002);
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), Dialog002, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), Dialog002, SLOT(reject()));
