...
public:
    ...
    KiranModuleWidget *widget_itemWgt;
...
" QAbstractScrollArea QScrollBar:vertical{border:0px;width: 0px;background-color:rgba(255,255,255,30);}"));
        ...
        widget_itemWgt = new KiranModuleWidget(KiranControlPanel);
        widget_itemWgt->setObjectName(QStringLiteral("widget_itemWgt"));

        horizontalLayout->addWidget(widget_itemWgt);
