...
QT_MOC_LITERAL(5, 71, 37), // "on_listWidget_item_currentIte..."
QT_MOC_LITERAL(6, 109, 8) // "previous"

    },
    "KiranModuleWidget\0onSelectedClassItemChanged\0"
    "\0QListWidgetItem*\0current\0"
    "on_listWidget_item_currentItemChanged\0"
    "previous"
};
...
void KiranModuleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onSelectedClassItemChanged((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->on_listWidget_item_currentItemChanged((*reinterpret_cast< QListWidgetItem*(*)>(_a[1])),(*reinterpret_cast< QListWidgetItem*(*)>(_a[2]))); break;
        default: ;
        }
    }
}
