...
public Q_SLOTS: // METHODS
    ...
    inline QDBusReply<qlonglong> GetPasswordExpirationPolicy(qlonglong &last_change_time, qlonglong &min_days_between_changes, qlonglong &max_days_between_changes, qlonglong &days_to_warn, qlonglong &days_after_expiration_until_lock)
    {
        QList<QVariant> argumentList;
        QDBusMessage reply = callWithArgumentList(QDBus::Block, QLatin1String("GetPasswordExpirationPolicy"), argumentList);
